PGMS=mmult_omp_timing matrix_times_vector pi mxv_omp_mpi mmult_mpi_omp
...
mmult_mpi_omp.o:	mmult_mpi_omp.c
	mpicc -c -w  -fopenmp -O3 mmult_mpi_omp.c

mmult_omp_timing:	mmult.o mmult_omp.o mmult_omp_timing.o
	gcc -o -w mmult -fopenmp -O3 mmult.o mmult_omp.o mmult_omp_timing.o -o mmult_omp_timing

mmult.o:	mmult.c
	gcc -c -w -O3 mmult.c

mmult_omp.o:	mmult_omp.c
	gcc -c -w -O3 -fopenmp mmult_omp.c

mmult_omp_timing.o:	mmult_omp_timing.c
	gcc -c -w -O3 mmult_omp_timing.c
...
mxv_omp_mpi:	mxv_omp_mpi.c
	mpicc -w -fopenmp -O3 -o mxv_omp_mpi mxv_omp_mpi.c
